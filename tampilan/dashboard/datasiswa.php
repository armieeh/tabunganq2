<?php  
 ...
 ?>
<body class="" style="background: linear-gradient(to right,#043927,#078d5f, #043927);;">
	<?php include '../navbar/nav.php'; ?>
	<div class="container pt-3 pb-2 mt-3 rounded border border-2 border-light" style="background: black;">
